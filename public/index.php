                    ...
                    <div class="row gx-5 align-items-center">
                        <div class="col-xxl-5">
                            ...
                            <div class="text-center text-xxl-start">
                                <div class="badge hero-badge bg-gradient-primary-to-secondary text-white mb-4"><div class="text-uppercase">Administration système &middot; Administration réseau &middot; DevOps</div></div>
                                <div class="fs-4 fw-light text-muted mr-0">Bienvenue sur mon portfolio !</div>
                                <h1 class="display-3 fw-bolder mb-5"><span class="text-gradient d-inline">Passionné & autodicate en informatique.</span></h1>
                                <div class="d-grid gap-3 d-sm-flex justify-content-sm-center justify-content-xxl-start mb-3">
                                    <a class="btn btn-primary btn-lg px-5 py-3 me-sm-3 fs-6 fw-bolder" href="/vues/cv.php">Mon CV</a>
                                    <a class="btn btn-outline-dark btn-lg px-5 py-3 fs-6 fw-bolder" href="/vues/projets.php">Mes projets</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-xxl-7">
